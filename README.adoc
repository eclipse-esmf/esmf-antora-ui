...
For image files of the ESMF logo (PNG, SVG, favicon), the color palette, and further visual material, refer to [the logo-and-color-palette section](docs/logo-and-color-palette/ESMF_description.md).
