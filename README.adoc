...
> [!NOTE]
> For image files of the ESMF logo (PNG, SVG, favicon), the color palette, and further visual material, refer to [docs/logo-and-color-palette/ESMF_description.md](docs/logo-and-color-palette/ESMF_description.md).
