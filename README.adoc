...
![ESMF logo small](docs/logo-and-color-palette/2023_ESMF_Logo_V1.1/Favicon/16x16/13_Fav_Color-16x16.png) For image files of the ESMF logo (PNG, SVG, favicon), the color palette, and further visual material, refer to [docs/logo-and-color-palette/ESMF_description.md](docs/logo-and-color-palette/ESMF_description.md).
